...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.row) {
        ...
        case 3:
        {
            NSString *content = [NSString stringWithFormat:@"appkey=%@\r\n appsecret=%@\r\n accs域名=%@\r\n mtop域名=%@\r\n ZCachepackageZipPrefix=%@\r\n ossBucketName=%@\r\n 高可用上报地址=%@\r\n 渠道ID=%@\r\n 设备ID=%@", [[EMASService shareInstance] appkey],[[EMASService shareInstance] appSecret], [[EMASService shareInstance] ACCSDomain], [[EMASService shareInstance] MTOPDomain], [[EMASService shareInstance] packageZipPrefixURL], [[EMASService shareInstance] OSSBucketName], [[EMASService shareInstance] HAReportURL], [[EMASService shareInstance] ChannelID], [self getUTDid]];
