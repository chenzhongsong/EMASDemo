...
@implementation EMASWXBarButton

@end

@implementation EMASWXNavigationImpl
                      ...
                      withContainer:(UIViewController *)container
{
    ...
    EMASHostViewController *vc = [[EMASHostViewController alloc] initWithNavigatorURL:[NSURL URLWithString:param[@"url"]]];
...
- (void)setNavigationBarHidden:(BOOL)hidden animated:(BOOL)animated
                 withContainer:(UIViewController *)container
{
    if (![container isKindOfClass:[EMASHostViewController class]]) {
        return;
    }
        ...
        withContainer:(UIViewController *)container
{
    if (param[@"title"]) {
        ...
        EMASWXBarButton *button = [EMASWXBarButton buttonWithType:UIButtonTypeRoundedRect];
...
{
    EMASWXBarButton *button = (EMASWXBarButton *)sender;
